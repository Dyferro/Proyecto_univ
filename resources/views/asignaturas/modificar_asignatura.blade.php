...
<div class="min-h-screen bg-gray-100 p-0 sm:p-12">
    <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
      <h1 class="text-2xl font-bold mb-8">Modificar Asignatura: {{$asignatura->id}}</h1> 

      <form action="{{route('asignaturas.update', $asignatura)}}" method="POST" novalidate>
        @csrf
        ...
        <div class="relative z-0 w-full mb-5">
            <input
              type="number"
              name="duracionhoras"
              value="{{old('duracionhoras',$asignatura->duracionhoras)}}"
              placeholder=" "
        ...
        <div class="relative z-0 w-full mb-5">
            <input
              type="number"
              name="nivel"
              value="{{old('nivel',$asignatura->nivel)}}"
              placeholder=" "
              class="pt-3 pb-2 pl-5 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200"
            />
        ...
        <br/>
        <br/>
        <button id="button" class="w-full px-6 py-3 mt-3 text-lg text-white transition-all duration-150 ease-linear rounded-lg shadow outline-none bg-indigo-500 hover:bg-indigo-600 hover:shadow-lg focus:outline-none" type="submit">Modificar</button>
    </form>
