 ...
 <header class="text-gray-100 bg-gray-900 body-font shadow w-full">
     <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
         <nav class="flex lg:w-4/5 flex-wrap items-center text-base md:ml-auto">
            ...
            <a class="mr-5 hover:text-gray-900 cursor-pointer border-b border-transparent hover:border-indigo-600" href="{{ route('plan-estudios') }}">Plan de estudios</a>
            <a class="mr-5 hover:text-gray-900 cursor-pointer border-b border-transparent hover:border-indigo-600" href="{{route('profesors.index')}}">Profesores</a>
